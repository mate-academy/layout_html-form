# HTML form
Replace `<aamelnyk>` with your Github username and copy the links to Pull Request description:
- [DEMO LINK](https://aamelnyk.github.io/layout_html-form/)
- [TEST REPORT LINK](https://aamelnyk.github.io/layout_html-form/report/html_report/)
