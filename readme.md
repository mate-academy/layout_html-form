...
- [DEMO LINK](https://MOstapchyk.github.io/layout_html-form/)
- [TEST REPORT LINK](https://MOstapchyk.github.io/layout_html-form/report/html_report/)
...
- Vertical distance between groups should be `20 px`
